...
class BertForTokenClassification(
    ...
    def __init__(
        self,
        classname="com.johnsnowlabs.nlp.annotators.classifier.dl.BertForTokenClassification",
        java_model=None,
    ):
    ...
    def loadSavedModel(folder, spark_session):
        ...
        jModel = _BertTokenClassifierLoader(
    ...
    @staticmethod
    def pretrained(
        name="bert_base_token_classifier_conll03", lang="en", remote_loc=None
    ):
        ...
        return ResourceDownloader.downloadModel(
            BertForTokenClassification, name, lang, remote_loc
        )
