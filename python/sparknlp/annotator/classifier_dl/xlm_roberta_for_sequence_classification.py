...
class XlmRoBertaForSequenceClassification(
    ...
    def __init__(
        self,
        classname="com.johnsnowlabs.nlp.annotators.classifier.dl.XlmRoBertaForSequenceClassification",
        java_model=None,
    ):
    ...
    def loadSavedModel(folder, spark_session):
        ...
        jModel = _XlmRoBertaSequenceClassifierLoader(
    ...
    @staticmethod
    def pretrained(
        name="xlm_roberta_base_sequence_classifier_imdb", lang="en", remote_loc=None
    ):
        ...
        return ResourceDownloader.downloadModel(
            XlmRoBertaForSequenceClassification, name, lang, remote_loc
        )
