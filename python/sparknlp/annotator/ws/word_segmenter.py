...
class WordSegmenterApproach(AnnotatorApproach):
    ...
    **Tip**:
    ...
    def __init__(self):
        ...
        self._setDefault(nIterations=5, frequencyThreshold=5, ambiguityThreshold=0.97)
...
class WordSegmenterModel(AnnotatorModel):
    ...
    def __init__(
        self,
        classname="com.johnsnowlabs.nlp.annotators.ws.WordSegmenterModel",
        java_model=None,
    ):
