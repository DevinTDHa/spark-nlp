...
class LongformerForTokenClassification(
    ...
    def __init__(
        self,
        classname="com.johnsnowlabs.nlp.annotators.classifier.dl.LongformerForTokenClassification",
        java_model=None,
    ):
    ...
    def loadSavedModel(folder, spark_session):
        ...
        jModel = _LongformerTokenClassifierLoader(
    ...
    @staticmethod
    def pretrained(
        name="longformer_base_token_classifier_conll03", lang="en", remote_loc=None
    ):
        ...
        return ResourceDownloader.downloadModel(
            LongformerForTokenClassification, name, lang, remote_loc
        )
