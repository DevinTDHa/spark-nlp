...
class RecursiveTokenizer(AnnotatorApproach):
    ...
    def __init__(self, classname="com.johnsnowlabs.nlp.annotators.RecursiveTokenizer"):
        super(RecursiveTokenizer, self).__init__(
            classname="com.johnsnowlabs.nlp.annotators.RecursiveTokenizer"
        )
        self._setDefault(
            prefixes=["'", '"', "(", "[", "\n"],
            infixes=["\n", "(", ")"],
...
class RecursiveTokenizerModel(AnnotatorModel):
    ...
    def __init__(
        self,
        classname="com.johnsnowlabs.nlp.annotators.RecursiveTokenizerModel",
        java_model=None,
    ):
