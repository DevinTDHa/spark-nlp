...
class RoBertaForSequenceClassification(
    ...
    def __init__(
        self,
        classname="com.johnsnowlabs.nlp.annotators.classifier.dl.RoBertaForSequenceClassification",
        java_model=None,
    ):
    ...
    def loadSavedModel(folder, spark_session):
        ...
        jModel = _RoBertaSequenceClassifierLoader(
    ...
    @staticmethod
    def pretrained(
        name="roberta_base_sequence_classifier_imdb", lang="en", remote_loc=None
    ):
        ...
        return ResourceDownloader.downloadModel(
            RoBertaForSequenceClassification, name, lang, remote_loc
        )
