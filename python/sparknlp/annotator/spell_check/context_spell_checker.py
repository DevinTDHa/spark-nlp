...
class ContextSpellCheckerApproach(AnnotatorApproach):
    ...
    @keyword_only
    def __init__(self):
        super(ContextSpellCheckerApproach, self).__init__(
            classname="com.johnsnowlabs.nlp.annotators.spell.context.ContextSpellCheckerApproach"
        )
...
class ContextSpellCheckerModel(AnnotatorModel):
    ...
    def __init__(
        self,
        classname="com.johnsnowlabs.nlp.annotators.spell.context.ContextSpellCheckerModel",
        java_model=None,
    ):
