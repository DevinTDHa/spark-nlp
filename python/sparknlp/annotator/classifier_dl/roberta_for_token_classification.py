...
class RoBertaForTokenClassification(
    ...
    def __init__(
        self,
        classname="com.johnsnowlabs.nlp.annotators.classifier.dl.RoBertaForTokenClassification",
        java_model=None,
    ):
    ...
    def loadSavedModel(folder, spark_session):
        ...
        jModel = _RoBertaTokenClassifierLoader(
    ...
    @staticmethod
    def pretrained(
        name="roberta_base_token_classifier_conll03", lang="en", remote_loc=None
    ):
        ...
        return ResourceDownloader.downloadModel(
            RoBertaForTokenClassification, name, lang, remote_loc
        )
