...
class AlbertEmbeddings(
    ...
    *Increasing model size when pretraining natural language representations
    ...
    def __init__(
        self,
        classname="com.johnsnowlabs.nlp.embeddings.AlbertEmbeddings",
        java_model=None,
    ):
        ...
        self._setDefault(
            batchSize=8, dimension=768, maxSentenceLength=128, caseSensitive=False
        )
    ...
    def pretrained(name="albert_base_uncased", lang="en", remote_loc=None):
        ...
        return ResourceDownloader.downloadModel(
            AlbertEmbeddings, name, lang, remote_loc
        )
