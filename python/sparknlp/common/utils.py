...
from sparknlp.internal.wrappers import _ExternalResource, _RegexRule
...
def ExternalResource(path, read_as=ReadAs.TEXT, options={}):
    ...
    """
    return _ExternalResource(path, read_as, options).apply()


def RegexRule(rule, identifier):
    return _RegexRule(rule, identifier).apply()
