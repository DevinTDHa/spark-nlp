...
class AlbertForTokenClassification(
    ...
    def __init__(
        self,
        classname="com.johnsnowlabs.nlp.annotators.classifier.dl.AlbertForTokenClassification",
        java_model=None,
    ):
        super(AlbertForTokenClassification, self).__init__(
            classname=classname, java_model=java_model
        )
        self._setDefault(batchSize=8, maxSentenceLength=128, caseSensitive=False)
    ...
    def loadSavedModel(folder, spark_session):
        ...
        jModel = _AlbertTokenClassifierLoader(
    ...
    @staticmethod
    def pretrained(
        name="albert_base_token_classifier_conll03", lang="en", remote_loc=None
    ):
        ...
        return ResourceDownloader.downloadModel(
            AlbertForTokenClassification, name, lang, remote_loc
        )
