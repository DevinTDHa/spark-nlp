...
class BertForSequenceClassification(
    ...
    def __init__(
        self,
        classname="com.johnsnowlabs.nlp.annotators.classifier.dl.BertForSequenceClassification",
        java_model=None,
    ):
    ...
    def loadSavedModel(folder, spark_session):
        ...
        jModel = _BertSequenceClassifierLoader(
    ...
    @staticmethod
    def pretrained(
        name="bert_base_sequence_classifier_imdb", lang="en", remote_loc=None
    ):
        ...
        return ResourceDownloader.downloadModel(
            BertForSequenceClassification, name, lang, remote_loc
        )
