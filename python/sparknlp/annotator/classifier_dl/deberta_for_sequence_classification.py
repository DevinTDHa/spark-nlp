...
class DeBertaForSequenceClassification(
    ...
    def __init__(
        self,
        classname="com.johnsnowlabs.nlp.annotators.classifier.dl.DeBertaForSequenceClassification",
        java_model=None,
    ):
    ...
    def loadSavedModel(folder, spark_session):
        ...
        jModel = _DeBertaSequenceClassifierLoader(
    ...
    @staticmethod
    def pretrained(
        name="deberta_base_sequence_classifier_imdb", lang="en", remote_loc=None
    ): # TODO: Pretrained model does not exist
        ...
        return ResourceDownloader.downloadModel(
            DeBertaForSequenceClassification, name, lang, remote_loc
        )
