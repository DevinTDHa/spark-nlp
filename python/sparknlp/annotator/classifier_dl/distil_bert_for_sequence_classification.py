...
class DistilBertForSequenceClassification(
    ...
    def __init__(
        self,
        classname="com.johnsnowlabs.nlp.annotators.classifier.dl.DistilBertForSequenceClassification",
        java_model=None,
    ):
    ...
    def loadSavedModel(folder, spark_session):
        ...
        jModel = _DistilBertSequenceClassifierLoader(
    ...
    @staticmethod
    def pretrained(
        name="distilbert_base_sequence_classifier_imdb", lang="en", remote_loc=None
    ):
        ...
        return ResourceDownloader.downloadModel(
            DistilBertForSequenceClassification, name, lang, remote_loc
        )
