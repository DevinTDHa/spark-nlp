...
class XlnetForSequenceClassification(
    ...
    def __init__(
        self,
        classname="com.johnsnowlabs.nlp.annotators.classifier.dl.XlnetForSequenceClassification",
        java_model=None,
    ):
    ...
    def loadSavedModel(folder, spark_session):
        ...
        jModel = _XlnetSequenceClassifierLoader(
    ...
    @staticmethod
    def pretrained(
        name="xlnet_base_sequence_classifier_imdb", lang="en", remote_loc=None
    ):
        ...
        return ResourceDownloader.downloadModel(
            XlnetForSequenceClassification, name, lang, remote_loc
        )
