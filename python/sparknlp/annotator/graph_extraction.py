...
class GraphExtraction(AnnotatorModel):
    ...
    typedDependencyParserModel = Param(
        Params._dummy(),
        "typedDependencyParserModel",
    ...
    def __init__(
        self,
        classname="com.johnsnowlabs.nlp.annotators.GraphExtraction",
        java_model=None,
    ):
        super(GraphExtraction, self).__init__(
            classname=classname, java_model=java_model
        )
        self._setDefault(maxSentenceSize=1000, minSentenceSize=2)
