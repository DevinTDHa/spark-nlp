...
class LanguageDetectorDL(AnnotatorModel, HasStorageRef):
    ...
    def __init__(
        self,
        classname="com.johnsnowlabs.nlp.annotators.ld.dl.LanguageDetectorDL",
        java_model=None,
    ):
        ...
        self._setDefault(
            threshold=0.5, thresholdLabel="Unknown", coalesceSentences=True
        )
    ...
    def pretrained(name="ld_wiki_tatoeba_cnn_21", lang="xx", remote_loc=None):
        ...
        return ResourceDownloader.downloadModel(
            LanguageDetectorDL, name, lang, remote_loc
        )
