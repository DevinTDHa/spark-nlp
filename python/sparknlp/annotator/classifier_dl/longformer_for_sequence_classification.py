...
class LongformerForSequenceClassification(
    ...
    def __init__(
        self,
        classname="com.johnsnowlabs.nlp.annotators.classifier.dl.LongformerForSequenceClassification",
        java_model=None,
    ):
    ...
    def loadSavedModel(folder, spark_session):
        ...
        jModel = _LongformerSequenceClassifierLoader(
    ...
    @staticmethod
    def pretrained(
        name="longformer_base_sequence_classifier_imdb", lang="en", remote_loc=None
    ):
        ...
        return ResourceDownloader.downloadModel(
            LongformerForSequenceClassification, name, lang, remote_loc
        )
