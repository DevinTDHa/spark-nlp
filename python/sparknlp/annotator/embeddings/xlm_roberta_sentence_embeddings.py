...
class XlmRoBertaSentenceEmbeddings(
    AnnotatorModel,
    ...
    *This paper shows that pretraining multilingual language models at scale leads to significant performance gains
    ...
    def __init__(
        self,
        classname="com.johnsnowlabs.nlp.embeddings.XlmRoBertaSentenceEmbeddings",
        java_model=None,
    ):
        ...
        self._setDefault(
            dimension=768, batchSize=8, maxSentenceLength=128, caseSensitive=True
        )
    ...
    def loadSavedModel(folder, spark_session):
        ...
        jModel = _XlmRoBertaSentenceLoader(
    ...
    def pretrained(name="sent_xlm_roberta_base", lang="xx", remote_loc=None):
        ...
        return ResourceDownloader.downloadModel(
            XlmRoBertaSentenceEmbeddings, name, lang, remote_loc
        )
