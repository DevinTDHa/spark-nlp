...
//  val prompt = new Param[String]("prompt", "")
  ...
  /** @group param */
  val penaltyPrompt = new Param[String](this, "penaltyPrompt", "Override which part of the prompt is penalized for repetition.")
  /** @group param */
...
//  val stream = new BooleanParam(this, "stream", "Whether to stream the output or not")
   ...
   * @group setParam
   */
  def setDynamicTemperatureRange(dynatempRange: Float ) =  {set(this.dynamicTemperatureRange, dynatempRange)}
  def setDynamicTemperatureExponent(dynatempExponent: Float ) =  {set(this.dynamicTemperatureExponent, dynatempExponent)}
   ...
   * @group setParam
   */
  def setFrequencyPenalty(frequencyPenalty: Float ) =  {set(this.frequencyPenalty, frequencyPenalty)}
...
// TODO: def setTokenBias(Float: Map<String, > logitBias) =  {set(this.Float, Float)}
   ...
   * @group setParam
   */
  def setDisableTokenIds(disableTokenIds: Array[Int] ) =  {set(this.disableTokenIds, disableTokenIds)}
...
//  def setSamplers(samplers: Sampler... ) =  {set(this.samplers, samplers)}
   ...
   * @group setParam
   */
  def setUseChatTemplate(useChatTemplate: Boolean ) =  {set(this.useChatTemplate, useChatTemplate)}
