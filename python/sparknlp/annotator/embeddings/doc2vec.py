...
class Doc2VecApproach(AnnotatorApproach, HasStorageRef, HasEnableCachingProperties):
    ...
    @keyword_only
    def __init__(self):
        super(Doc2VecApproach, self).__init__(
            classname="com.johnsnowlabs.nlp.embeddings.Doc2VecApproach"
        )
        self._setDefault(
            vectorSize=100,
            windowSize=5,
...
class Doc2VecModel(AnnotatorModel, HasStorageRef, HasEmbeddingsProperties):
    ...
    def __init__(
        self, classname="com.johnsnowlabs.nlp.embeddings.Doc2VecModel", java_model=None
    ):
        super(Doc2VecModel, self).__init__(classname=classname, java_model=java_model)
