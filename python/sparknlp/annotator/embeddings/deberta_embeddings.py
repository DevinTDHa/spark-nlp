...
class DeBertaEmbeddings(
    ...
    *Paper abstract: Recent progress in pre-trained neural language models has
    ...
    def __init__(
        self,
        classname="com.johnsnowlabs.nlp.embeddings.DeBertaEmbeddings",
        java_model=None,
    ):
        ...
        self._setDefault(
            batchSize=8, dimension=768, maxSentenceLength=128, caseSensitive=True
        )
    ...
    def pretrained(name="deberta_v3_base", lang="en", remote_loc=None):
        ...
        return ResourceDownloader.downloadModel(
            DeBertaEmbeddings, name, lang, remote_loc
        )
