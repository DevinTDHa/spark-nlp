...
class DistilBertForTokenClassification(
    ...
    def __init__(
        self,
        classname="com.johnsnowlabs.nlp.annotators.classifier.dl.DistilBertForTokenClassification",
        java_model=None,
    ):
    ...
    def loadSavedModel(folder, spark_session):
        ...
        jModel = _DistilBertTokenClassifierLoader(
    ...
    @staticmethod
    def pretrained(
        name="distilbert_base_token_classifier_conll03", lang="en", remote_loc=None
    ):
