...
class GraphFinisher(AnnotatorTransformer):
    ...
    outputAsArray = Param(
        Params._dummy(),
        "outputAsArray",
        "Finisher generates an Array with the results",
        typeConverter=TypeConverters.toBoolean,
    )
    ...
    @keyword_only
    def __init__(self):
        super(GraphFinisher, self).__init__(
            classname="com.johnsnowlabs.nlp.GraphFinisher"
        )
        self._setDefault(cleanAnnotations=True, outputAsArray=True)
