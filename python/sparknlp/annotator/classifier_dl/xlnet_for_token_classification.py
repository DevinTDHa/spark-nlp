...
class XlnetForTokenClassification(
    ...
    def __init__(
        self,
        classname="com.johnsnowlabs.nlp.annotators.classifier.dl.XlnetForTokenClassification",
        java_model=None,
    ):
    ...
    def loadSavedModel(folder, spark_session):
        ...
        jModel = _XlnetTokenClassifierLoader(
    ...
    @staticmethod
    def pretrained(
        name="xlnet_base_token_classifier_conll03", lang="en", remote_loc=None
    ):
        ...
        return ResourceDownloader.downloadModel(
            XlnetForTokenClassification, name, lang, remote_loc
        )
