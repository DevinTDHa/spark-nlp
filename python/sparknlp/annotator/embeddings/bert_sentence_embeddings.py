...
class BertSentenceEmbeddings(
    ...
    *We introduce a new language representation model called BERT, which stands
    ...
    def __init__(
        self,
        classname="com.johnsnowlabs.nlp.embeddings.BertSentenceEmbeddings",
        java_model=None,
    ):
        ...
        self._setDefault(
            dimension=768, batchSize=8, maxSentenceLength=128, caseSensitive=False
        )
    ...
    def pretrained(name="sent_small_bert_L2_768", lang="en", remote_loc=None):
        ...
        return ResourceDownloader.downloadModel(
            BertSentenceEmbeddings, name, lang, remote_loc
        )
