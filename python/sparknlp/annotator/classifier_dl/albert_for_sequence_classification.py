...
class AlbertForSequenceClassification(
    ...
    def __init__(
        self,
        classname="com.johnsnowlabs.nlp.annotators.classifier.dl.AlbertForSequenceClassification",
        java_model=None,
    ):
    ...
    def loadSavedModel(folder, spark_session):
        ...
        jModel = _AlbertSequenceClassifierLoader(
    ...
    @staticmethod
    def pretrained(
        name="albert_base_sequence_classifier_imdb", lang="en", remote_loc=None
    ):
        ...
        return ResourceDownloader.downloadModel(
            AlbertForSequenceClassification, name, lang, remote_loc
        )
