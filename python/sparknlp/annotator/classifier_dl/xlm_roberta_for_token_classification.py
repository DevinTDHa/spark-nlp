...
class XlmRoBertaForTokenClassification(
    AnnotatorModel, HasCaseSensitiveProperties, HasBatchedAnnotate
):
    ...
    def __init__(
        self,
        classname="com.johnsnowlabs.nlp.annotators.classifier.dl.XlmRoBertaForTokenClassification",
        java_model=None,
    ):
        super(XlmRoBertaForTokenClassification, self).__init__(
            classname=classname, java_model=java_model
        )
        self._setDefault(batchSize=8, maxSentenceLength=128, caseSensitive=True)
    ...
    def loadSavedModel(folder, spark_session):
        ...
        jModel = _XlmRoBertaTokenClassifierLoader(
    ...
    @staticmethod
    def pretrained(
        name="xlm_roberta_base_token_classifier_conll03", lang="en", remote_loc=None
    ):
        ...
        return ResourceDownloader.downloadModel(
            XlmRoBertaForTokenClassification, name, lang, remote_loc
        )
