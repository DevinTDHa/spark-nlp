...
class T5Transformer(AnnotatorModel, HasBatchedAnnotate):
    ...
    *Transfer learning, where a model is first pre-trained on a data-rich task
    ...
    def __init__(
        self,
        classname="com.johnsnowlabs.nlp.annotators.seq2seq.T5Transformer",
        java_model=None,
    ):
        super(T5Transformer, self).__init__(classname=classname, java_model=java_model)
        self._setDefault(
            task="",
            minOutputLength=0,
            maxOutputLength=20,
